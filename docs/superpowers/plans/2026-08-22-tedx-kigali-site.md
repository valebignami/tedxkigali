...
rm src/content/talks/2024-03-09-the-cooperative-that-refused-a-chairman.md
rm src/content/talks/2024-03-09-the-part-i-left-out.md
...
rm src/content/talks/2024-11-09-what-the-model-could-not-see.md
...
rm src/content/talks/2025-05-24-the-school-fence.md
rm src/content/talks/2025-05-24-what-i-would-say-with-three-minutes.md
...
rm src/content/events/tedxkigali-countdown-2024.md
rm src/content/events/tedxkigali-countdown-2025.md
rm src/content/events/tedxkigali-kids-2025.md
rm src/content/events/tedxkigali-women-2024.md
rm src/content/events/tedxkigali-women-2025.md
rm src/content/events/tedxkigali-youth-2023.md
...
>
> Verificare con `ls src/content/talks src/content/events src/content/speakers` che restino solo i contenuti reali, e con una ricerca di `dQw4w9WgXcQ`, `example-ticketing.com`, `Diane Uwimana`, `Rising`, `Roots`, `Threads`, `In the Room`, `Out Loud`, `First Draft`, `Take the Mic`, `Ask Better`, `Why? Why? Why?`, `Ten Years` e `Ground Truth` che non ne resti traccia.
